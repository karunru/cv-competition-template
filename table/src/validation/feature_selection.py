...
class KarunruSpearmanCorrelationEliminator(SelectorMixin):
    ...
    def _not_remove(self, feat_a: str, feat_b: str):
        return feat_b in self.not_remove_cols or feat_a in self.not_remove_cols
    ...
    def fit(self, input_df: XDataFrame) -> None:
        ...
        for i in tqdm(range(len(org_cols) - 1)):
            ...
            for j in range(i + 1, len(org_cols)):
                ...
                if self._not_remove(feat_a_name, feat_b_name):
                    continue
